<template>
	<section>
		...
		<div>
			<div class="home_logo item_container_style">asdfasdf</div>
			<router-link to="/item">asdfasd</router-link>
		</div>
		<div>
			<div class="item_back item_container_style">
				<div class="item_list_container">
					<header class="item_title">asdfasd</header>
					<ul>
						<li>asdfasd</li>
					</ul>
				</div>
			</div>
			<span class="next_item button_style">asdfasdf</span>
		</div>
	</section>
</template>
<script>
